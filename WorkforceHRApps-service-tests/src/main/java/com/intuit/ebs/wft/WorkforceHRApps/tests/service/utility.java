...
public class utility extends BoomiTestBase{
	    ...
	    public   void LMSValidation(String EmpIdentifier,String JasonTag,String value) throws Exception{
		       ...
		       String payload = Utility.readText(BoomiTest.LMS_PATH+"/"+"lms.txt");
		       ...
		       Response resp=Utility.PostCall(requestSpec, BoomiTest.LMS_PATH, "lms.txt", lms_url);
	    ...
	    public void Taleovalidation(String name) throws IOException{
	        ...
	        String payload=Utility.readText(BoomiTest.Taleo_path+"/"+"Upserttaleo.txt");
	        Response TaleoRep=Utility.PostCall(requestSpec, BoomiTest.Taleo_path, "Upserttaleo.txt", taleo_URL);
	...
	public void b2btokenAndData(String paramName,String query) throws Exception{
	    	...
	    	Response rep=Utility.PostCall(requestSpec, BoomiTest.B2B_PATH, "b2b.txt", b2bPosturl);
	    ...
	    public void b2ctokenAndData(String paramName,String query,String corpid) throws Exception{
	    	...
	    	logger.info("==============Started Post call==========================");
	    	Response rep1=Utility.PostCall(requestSpec, BoomiTest.B2B_PATH, "b2b.txt", b2cPosturl);
